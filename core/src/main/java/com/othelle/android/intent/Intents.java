package com.othelle.android.intent;
...
/**
 * @author v.vlasov
 *         Based on work of Dmitry Tarasov
 */
public class Intents {
    ...
    public static Intent openPlayStore(Context context, boolean openInBrowser) {
        return openPlayStore(context, context.getPackageName(), openInBrowser);
    }
     ...
     *                      if Play Store app not found on device
     */
    public static Intent openPlayStore(Context context, String appPackageName, boolean openInBrowser) {
        Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + appPackageName));
        if (isIntentAvailable(context, marketIntent)) {
            return marketIntent;
        }
        if (openInBrowser) {
            return openUrl("https://play.google.com/store/apps/details?id=" + appPackageName);
        }
        return marketIntent;
    }
     ...
     * @see #openUrl(String)
     */
    public static Intent openUrl(URL url) {
    ...
    public static boolean isCropAvailable(Context context) {
        ...
        intent.setType("image/*");
        return Intents.isIntentAvailable(context, intent);
    }
