...
package com.othelle.android.widget.numberpicker;
...
import com.othelle.android.widget.R;
...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final float TOP_AND_BOTTOM_FADING_EDGE_STRENGTH = 10f;
    ...
    /**
     * Returns value but before returning it - finishes editing
     * @return
     */
    public int getValueChangeAware() {
        if (mInputText != null) {
            try {
                int value = Integer.parseInt(mInputText.getText().toString());
    ...
    public void setTextAppearance(int resid) {
        mInputText.setTextAppearance(getContext(), resid);
        initDrawingParameters();
    }
}
